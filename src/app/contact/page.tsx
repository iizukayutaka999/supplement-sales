    ...
    <>
      ...
      <div className="pt-20 md:pt-24">
        ...
        <section className="py-16 md:py-28 px-4 md:px-16">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.15fr] gap-12 md:gap-28 items-start max-w-6xl mx-auto">
            {/* Contact Info */}
            <div className="md:sticky md:top-32">
              <SectionHeading tag="Contact" title="お問い合わせ" />
              <p className="text-sm md:text-[0.9rem] leading-relaxed md:leading-[2.3] text-text-muted mb-8 md:mb-12 mt-6 font-light">
                原料のご相談・サンプルのご依頼・お見積もりなど、
                お気軽にお問い合わせください。
                通常2営業日以内にご返答いたします。
              </p>
              <div className="flex flex-col gap-5 md:gap-6 pt-6 md:pt-8 border-t border-border">
                {[
                  { label: "会社名", value: company.name },
                  { label: "住所", value: company.address.full },
                  ...
                  >
                    <span className="text-[0.6rem] tracking-[0.35em] text-gold/90 min-w-[4rem] md:min-w-[5rem] pt-0.5 shrink-0 uppercase font-medium">
                      {detail.label}
                    </span>
